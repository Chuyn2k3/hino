...
// import 'package:hino/model/last_key.dart';
...
//     new NotiGroup(
//         name: Api.language == "vi" ? "Quá tốc độ" : "Over Speed"),
//     // new NotiGroup(name: "เข้าพื้นที่เสี่ยง"),
//     // new NotiGroup(name: "ออกพื้นที่เสี่ยง"),
//     new NotiGroup(
//         name: Api.language == "vi"
//             ? "Thông báo tới trung tâm dịch vụ"
//             : "Maintenance Remind"),
//     new NotiGroup(
//         name: Api.language == "vi" ? "Đèn cảnh báo" : "Engine Lamp")
//   ];
...
//                               ),
//                               Text(
//                                 carGroup.notifications.length.toString() +
//                                     " " +
//                                     Languages.of(context)!.unit_times,
//                                 style: TextStyle(
//                                   color: ColorCustom.blue,
...
//                               ),
//                               Text(
//                                 driverGroup.notifications.length.toString() +
//                                     " " +
//                                     Languages.of(context)!.unit_times,
//                                 style: TextStyle(
//                                   color: ColorCustom.blue,
