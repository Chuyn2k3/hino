...
import 'package:hino/model/raw_data_set.dart';
                                  ...
                                  SfCartesianChart(
                                    ...
                                    primaryXAxis: CategoryAxis(
                                      ...
                                      axisLabelFormatter:
                                          (axisLabelRenderArgs) {
                                        var text = "";
                                        if (axisLabelRenderArgs.text ==
                                            "primaryYAxis") {
                                          text = axisLabelRenderArgs.text;
                                          if (axisLabelRenderArgs.value == 0) {
                                            text =
                                                "0 " + Languages.of(context)!.h;
                                          } else if (axisLabelRenderArgs
                                                  .value ==
                                              20) {
                                            text =
                                                "4 " + Languages.of(context)!.h;
                                          } else if (axisLabelRenderArgs
                                                  .value ==
                                              40) {
                                            text =
                                                "8 " + Languages.of(context)!.h;
                                          } else if (axisLabelRenderArgs
                                                  .value ==
                                              60) {
                                            text = "12 " +
                                    ...
                                    tooltipBehavior: TooltipBehavior(
                                        ...
                                        builder: (dynamic data,
                                          ...
                                          var a = " " +
                                              ...
                                              " " +
                                              Utils.numberFormatInt(calCarCount(
                                                  data.driv,
                                    ...
                                    series: <CartesianSeries<dynamic, dynamic>>[
                                      StackedColumn100Series<DashboardData,
                                        ...
                                        yValueMapper:
                                            (DashboardData sales, _) =>
                                                sales.driv,
                                        name: Languages.of(context)!.driving,
                                        dataLabelSettings:
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      Utils.numberFormatInt(calCarCount(drive,
                                              dashboard!.vehicle_count)) +
                                          " h : " +
                                          ((drive * 100) / sum)
                                              .toStringAsFixed(1) +
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      Utils.numberFormatInt(calCarCount(parking,
                                              dashboard!.vehicle_count)) +
                                          " h : " +
                                          ((parking * 100) / sum)
                                              .toStringAsFixed(1) +
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      Utils.numberFormatInt(calCarCount(offline,
                                              dashboard!.vehicle_count)) +
                                          " h : " +
                                          ((offline * 100) / sum)
                                              .toStringAsFixed(1) +
