...
//           List.from(value['vehicles']).map((a) => Vehicle.fromJson(a)).toList();
...
//                           fontWeight: FontWeight.bold),
//                     ),
//                     Text("${factoryClick!.lat},${factoryClick!.lng}",
//                         style: const TextStyle(
//                           color: Colors.grey,
//                           fontSize: 12,
//                         )),
...
//                   //     // fetchAndUpdateData(); // Nếu muốn lấy lại dữ liệu mới theo vùng bản đồ
//                   //     _manager.updateMap();
//                   //   });
//                   // },
//                   //tối ưu
