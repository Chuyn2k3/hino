...
class _PageState extends State<HomeCarPage>
  ...
  List io_name = ["driving", "idling", "ign.off", "offline"];
    ...
    for (Vehicle v in list) {
      ...
      if (value.status[0] && v.gps!.io_name!.toLowerCase() == io_name[0]) {
        aa.add(v);
          ...
          v.gps!.io_name!.toLowerCase() == io_name[1]) {
        aa.add(v);
      } else if (value.status[2] &&
          v.gps!.io_name!.toLowerCase() == io_name[2]) {
        aa.add(v);
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    tabController!.index == 0
                        ? listSearchGroup.length.toString() + ' Fleet'
                        : listSearchVehicle.length.toString() +
                            ' ' +
                            Languages.of(context)!.unit,
                    style: TextStyle(
                      color: ColorCustom.blue,
