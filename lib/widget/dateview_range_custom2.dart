...
class DateViewRangeCustom2View extends StatefulWidget {
  DateViewRangeCustom2View(
      ...
      required this.returnDate, this.limit,this.colors,this.disable})
      : super(key: key);
...
class _TextFieldCustomViewState extends State<DateViewRangeCustom2View> {
  ...
  _selectDate(BuildContext context) async {
    ...
    setState(() {
      ...
      widget.controller.text = DateFormat('dd MMM yy').format(picked.start) +
          " - " +
          DateFormat('dd MMM yy').format(picked.end);
    });
  }
            ...
            return Center(
              child: Container(
                ...
                child: SfDateRangePicker(
                  ...
                  onSelectionChanged: (args) {
                    if (args.value is PickerDateRange) {
                      ...
                      if(rangeStartDate!=null&&rangeEndDate!=null){
                        widget.controller.text = DateFormat('dd MMM yy').format(rangeStartDate!) +
                            " - " +
                            DateFormat('dd MMM yy').format(rangeEndDate!);
                  ...
                  maxDate: widget.limit!=null?(rangeStartDate != null
                      ? rangeStartDate!.add(Duration(days: widget.limit!))
                      : null):null,
                  minDate: widget.limit!=null?(rangeStartDate != null ? rangeStartDate! : null):null,
        ...
        child: Row(
          children: [
            ...
            Expanded(child:   TextField(
              ...
              enabled: false,
              style: TextStyle(color: widget.colors!=null?widget.colors!:Colors.black),
